package com.helin.accountingapp.datepicker;
...
public class CustomDatePicker implements View.OnClickListener,PickerView.OnSelectListener {
    ...
    private void initView() {
        ...
        mTvYearUnit=mPickerDialog.findViewById(R.id.tv_year);
        mTvMonthUnit=mPickerDialog.findViewById(R.id.tv_month);
        mTvDayUnit=mPickerDialog.findViewById(R.id.tv_day);
