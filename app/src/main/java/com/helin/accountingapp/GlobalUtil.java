...
public class GlobalUtil {
    ...
    public final static LinkedList<CategoryResBean> costRes = new LinkedList<>();
    ...
    private  static String[] costTitle = {"一般", "用餐", "酒水", "商店", "购物", "Personal", "游戏", "电影", "社交", "交通",
            "应用", "通讯", "数码", "礼物", "住房", "旅行", "门票", "学习", "医疗", "转账"};
    ...
    private static String[] earnTitle = {"一般", "报销", "薪资", "红包", "兼职", "奖金", "投资"};
